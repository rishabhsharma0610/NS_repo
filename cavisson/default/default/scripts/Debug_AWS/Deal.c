...
void Deal()
{
    ...
    ns_start_transaction("Deal");
    ns_web_url ("Deal",
          "URL=https://blue-mobileapi.gstop-preprod.com/v2/deals",
         //  "URL=https://blue-mobileapi.gstop-preprod.com/adapter/v2/deals",
           "METHOD=GET",
...
//           "HEADER=X-Amz-Date: 20200922T085405Z",
        ...
        //   "HEADER=X-GS-Override: aa9Sul1eiYuPoamu",
         //  "HEADER=x-gs-native-app: android-v4.4.0",
           ...
           "HEADER=correlation-id: Deal_{CorrChar}{CorrID}",
     
    );
           ns_end_transaction("Deal", NS_AUTO_STATUS);
