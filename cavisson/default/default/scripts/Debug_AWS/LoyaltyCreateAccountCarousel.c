/*-----------------------------------------------------------------------------
    Name: Loyalty_Create_Account_Carousel
...
void LoyaltyCreateAccountCarousel()
{

    ns_start_transaction("LoyaltyCreateAccountCarousel");
    ns_web_url ("LoyaltyCreateAccountCarousel",
         // "URL=https://blue-mobileapi.gamestop.com/v2/content-service/loyalty/account?slotId={LtyAccountSlotIdSP}",
          "URL=https://api-test1.gamestop.com/adapter/v2/content-service/loyalty/account?slotId={LtyAccountSlotIdSP}",
           "METHOD=GET",
...
"HEADER=Pragma:akamai-x-get-client-ip, akamai-x-cache-on, akamai-x-cache-remote-on, akamai-x-check-cacheable, akamai-x-get-cache-key, akamai-x-get-extracted-values, akamai-x-get-nonces, akamai-x-get-ssl-client-session-id, akamai-x-get-true-cache-key, akamai-x-serial-no, akamai-x-feo-trace, akamai-x-get-request-id",
           "HEADER=correlation-id: LoyaltyCreateAccountCarousel_{CorrChar}{CorrID}",
           "HEADER=Authorization:JWTToken {AccessTokenSP}",
     
    );
           ns_end_transaction("LoyaltyCreateAccountCarousel", NS_AUTO_STATUS);
