...
void UpdateprofileHomeStore()

{

    ns_start_transaction("UpdateprofileHomeStore");
    ns_web_url ("UpdateprofileHomeStore",
           //"URL=https://blue-mobileapi.gstop-preprod.com/v2/profiles/me/HomeStoreNumber/{StoreIdsFP}",
           "URL=https://api-test1.gamestop.com/adapter/v2/profiles/me/HomeStoreNumber/{StoreIdsFP}",
           "METHOD=PUT",
...
"HEADER=Pragma:akamai-x-get-client-ip, akamai-x-cache-on, akamai-x-cache-remote-on, akamai-x-check-cacheable, akamai-x-get-cache-key, akamai-x-get-extracted-values, akamai-x-get-nonces, akamai-x-get-ssl-client-session-id, akamai-x-get-true-cache-key, akamai-x-serial-no, akamai-x-feo-trace, akamai-x-get-request-id",
           "HEADER=correlation-id: UpdateprofileHomeStore_{CorrChar}{CorrID}"
           
    );
           ns_end_transaction("UpdateprofileHomeStore", NS_AUTO_STATUS);
