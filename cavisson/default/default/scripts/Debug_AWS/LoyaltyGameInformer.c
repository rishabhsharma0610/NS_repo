...
void LoyaltyGameInformer()
{

    ns_start_transaction("LoyaltyGameInformer");
    ns_web_url ("LoyaltyGameInformer",
          "URL=https://api-test1.gamestop.com/adapter/v2/content-service/loyalty/gi?slotId={LtyPlayerSlotIdSP}",
          // "URL=https://blue-mobileapi.gamestop.com/adapter/v2/content-service/loyalty/gi?slotId={LtyPlayerSlotIdSP}",
           "METHOD=GET",
...
"HEADER=Pragma:akamai-x-get-client-ip, akamai-x-cache-on, akamai-x-cache-remote-on, akamai-x-check-cacheable, akamai-x-get-cache-key, akamai-x-get-extracted-values, akamai-x-get-nonces, akamai-x-get-ssl-client-session-id, akamai-x-get-true-cache-key, akamai-x-serial-no, akamai-x-feo-trace, akamai-x-get-request-id",
           "HEADER=correlation-id: LoyaltyGameInf{CorrChar}{CorrID}",
           "HEADER=Authorization:JWTToken {AccessTokenSP}",
     
    );
           ns_end_transaction("LoyaltyGameInformer", NS_AUTO_STATUS);
