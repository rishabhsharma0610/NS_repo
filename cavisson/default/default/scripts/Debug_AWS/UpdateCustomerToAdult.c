...
void UpdateCustomerToAdult()

{

       if (strcmp(ns_eval_string("{AdultCheckSP}"),"false") == 0) 
         {

    ns_start_transaction("UpdateCustomerToAdult");
    ns_web_url ("UpdateCustomerToAdult",
          // "URL=https://blue-mobileapi.gstop-preprod.com/v2/customers/setAdult",
            "URL=https://api-test1.gamestop.com/adapter/v2/customers/setAdult",
           "METHOD=PATCH",
...
"HEADER=Pragma:akamai-x-get-client-ip, akamai-x-cache-on, akamai-x-cache-remote-on, akamai-x-check-cacheable, akamai-x-get-cache-key, akamai-x-get-extracted-values, akamai-x-get-nonces, akamai-x-get-ssl-client-session-id, akamai-x-get-true-cache-key, akamai-x-serial-no, akamai-x-feo-trace, akamai-x-get-request-id",
           "HEADER=correlation-id: UpdateCustomerToAdult_{CorrChar}{CorrID}",
           
    );
           ns_end_transaction("UpdateCustomerToAdult", NS_AUTO_STATUS);
