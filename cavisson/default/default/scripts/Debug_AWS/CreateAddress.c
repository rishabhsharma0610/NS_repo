...
void CreateAddress()
{
    ...
    ns_start_transaction("CreateAddress");
    ns_web_url ("CreateAddress",
          // "URL=https://blue-mobileapi.gamestop.com/v2/customers/CreateCustomerV2",
           "URL=https://api-test1.gamestop.com/adapter/v2/customers/addresses/create",
           "METHOD=POST",
...
"HEADER=Pragma:akamai-x-get-client-ip, akamai-x-cache-on, akamai-x-cache-remote-on, akamai-x-check-cacheable, akamai-x-get-cache-key, akamai-x-get-extracted-values, akamai-x-get-nonces, akamai-x-get-ssl-client-session-id, akamai-x-get-true-cache-key, akamai-x-serial-no, akamai-x-feo-trace, akamai-x-get-request-id",
           ...
           "BODY=$CAVINCLUDE$=CreateAddress.json",
     
    );
           ns_end_transaction("CreateAddress", NS_AUTO_STATUS);
