...
//nsl_static_var(SKUidSP:1, File=/home/cavisson/Game_Stop/data/GS/FlashNewSkusList.txt, Refresh=SESSION, Mode=RANDOM, EncodeMode=All, CopyFileToTR=Yes);


nsl_search_var(AccessTokenSP, PAGE=RegAuth, PAGE=RefreshAuth, PAGE=GuestAuth, PAGE=CreateCustomer, PAGE=CreateCustomerAsPlayer, LB="{\"access_token\":\"", RB="\",\"token_type\"", LBMATCH=FIRST, SaveOffset=0, RETAINPREVALUE="YES", EncodeMode=Specified, CharsToEncode="=+/");
...
nsl_search_var(LtySlotMainSP, PAGE=GetConfig, LB="\"LoyaltyPageSlotDetails\":{", RB="},\"DefaultStore\"", LBMATCH=FIRST, SaveOffset=0, RETAINPREVALUE="YES", EncodeMode=None);
