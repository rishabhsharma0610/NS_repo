...
void PreOrdersHistory()
{

    ns_start_transaction("PreOrdersHistory");
    ns_web_url ("PreOrdersHistory",
         //  "URL=https://blue-mobileapi.gamestop.com/v2/customers/preOrders",
           "URL=https://api-test1.gamestop.com/adapter/v2/customers/preOrders",
           "METHOD=GET",
...
"HEADER=Pragma:akamai-x-get-client-ip, akamai-x-cache-on, akamai-x-cache-remote-on, akamai-x-check-cacheable, akamai-x-get-cache-key, akamai-x-get-extracted-values, akamai-x-get-nonces, akamai-x-get-ssl-client-session-id, akamai-x-get-true-cache-key, akamai-x-serial-no, akamai-x-feo-trace, akamai-x-get-request-id",
           "HEADER=correlation-id: PreOrdersHistory_{CorrChar}{CorrID}",
     
    );
           ns_end_transaction("PreOrdersHistory", NS_AUTO_STATUS);
