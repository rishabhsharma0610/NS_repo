/*-----------------------------------------------------------------------------
    Name: Recommendations_AddToCart
...
void Recommendations_AddToCart()
{
return;

    ns_start_transaction("Recommendations_AddToCart");
    ns_web_url ("Recommendations_AddToCart",
          "URL=https://blue-mobileapi.gstop-preprod.com/v2/recommendation/syncdata/addToCart",
         //   "URL=https://blue-mobileapi.gstop-preprod.com/adapter/v2/recommendation/syncdata/addToCart",
           "METHOD=POST",
...
"HEADER=Pragma:akamai-x-get-client-ip, akamai-x-cache-on, akamai-x-cache-remote-on, akamai-x-check-cacheable, akamai-x-get-cache-key, akamai-x-get-extracted-values, akamai-x-get-nonces, akamai-x-get-ssl-client-session-id, akamai-x-get-true-cache-key, akamai-x-serial-no, akamai-x-feo-trace, akamai-x-get-request-id",
           "HEADER=correlation-id: Rcmndtns_ATC_{CorrChar}{CorrID}",
           "BODY=$CAVINCLUDE$=Recommendations_AddtoCart.json",
    );
           ns_end_transaction("Recommendations_AddToCart", NS_AUTO_STATUS);
