...
{
//return;
    ns_start_transaction("RegGetCart");
    ns_web_url ("RegGetCart",
           "URL=https://blue-mobileapi.gstop-preprod.com/v2/carts/me",
           "METHOD=GET",
...
"HEADER=Pragma:akamai-x-get-client-ip, akamai-x-cache-on, akamai-x-cache-remote-on, akamai-x-check-cacheable, akamai-x-get-cache-key, akamai-x-get-extracted-values, akamai-x-get-nonces, akamai-x-get-ssl-client-session-id, akamai-x-get-true-cache-key, akamai-x-serial-no, akamai-x-feo-trace, akamai-x-get-request-id",
           "HEADER=correlation-id: RegGetCart_{CorrChar}{CorrID}",
     
    );
           ns_end_transaction("RegGetCart", NS_AUTO_STATUS);
         ns_page_think_time(0);


//         	printf("### LineItemId count check [%d]\n", ns_get_int_val("LineItemIdCountSP_count"));
//         	printf("### LineItemId check [%s]\n", ns_eval_string("{LineItemIdSP}"));
//         	printf("### ProdInvCheck check [%d]\n", ns_get_int_val("ProdInvCheckSP")); 
