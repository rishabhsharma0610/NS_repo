...
void TypeHeadSearchProduct()
{

    ns_start_transaction("TypeHeadSearchProduct");
    ns_web_url ("TypeHeadSearchProduct",
          // "URL=https://blue-mobileapi.gstop-preprod.com/v2/productsV2/typeahead?search={SearchFP}",
           "URL=https://api-test1.gamestop.com/adapter/v2/productsV2/typeahead?search={SearchFP}",
           "METHOD=GET",
...
"HEADER=Pragma:akamai-x-get-client-ip, akamai-x-cache-on, akamai-x-cache-remote-on, akamai-x-check-cacheable, akamai-x-get-cache-key, akamai-x-get-extracted-values, akamai-x-get-nonces, akamai-x-get-ssl-client-session-id, akamai-x-get-true-cache-key, akamai-x-serial-no, akamai-x-feo-trace, akamai-x-get-request-id",
           "HEADER=correlation-id: TypeHeadSearchProduct_{CorrChar}{CorrID}",
     
    );
           ns_end_transaction("TypeHeadSearchProduct", NS_AUTO_STATUS);
         ns_page_think_time(0);

 	ns_save_string(ns_eval_string("{ProductIDTypeHeadSP}"),"DV_ProductID");
