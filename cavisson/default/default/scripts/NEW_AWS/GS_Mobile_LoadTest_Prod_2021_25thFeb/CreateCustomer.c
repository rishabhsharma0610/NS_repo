...
snprintf(EmailValue, 64, "%s", ns_eval_string("Cav{CreateEmailRP}{CreateUQ}@bhexacttarget.com"));
ns_save_string(EmailValue,"DV_EmailValue");

ns_save_data_ex("/home/cavisson/Game_Stop/data/GS/Mobile/Create_Mobile_EmailIds.txt",NS_APPEND_FILE,"%s",ns_eval_string("Cav{CreateEmailRP}{CreateUQ}@bhexacttarget.com,GameStopPerf#01"));
