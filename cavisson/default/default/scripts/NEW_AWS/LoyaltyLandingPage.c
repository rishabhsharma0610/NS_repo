...
void LoyaltyLandingPage()
{

    ns_start_transaction("LoyaltyLandingPage");
    ns_web_url ("LoyaltyLandingPage",
           "URL=https://api-test1.gamestop.com/adapter/v2/content-service/loyalty/landing?user=guest",
           // "URL=https://blue-mobileapi.gamestop.com/adapter/v2/content-service/loyalty/landing?user=guest",
           "METHOD=GET",
...
"HEADER=Pragma:akamai-x-get-client-ip, akamai-x-cache-on, akamai-x-cache-remote-on, akamai-x-check-cacheable, akamai-x-get-cache-key, akamai-x-get-extracted-values, akamai-x-get-nonces, akamai-x-get-ssl-client-session-id, akamai-x-get-true-cache-key, akamai-x-serial-no, akamai-x-feo-trace, akamai-x-get-request-id",
           "HEADER=correlation-id: Loyalty_Landing_Page_{CorrChar}{CorrID}",
           "HEADER=Authorization:JWTToken {AccessTokenSP}",
     
    );
           ns_end_transaction("LoyaltyLandingPage", NS_AUTO_STATUS);
