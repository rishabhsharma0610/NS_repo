...
void GetStockpilePointPreferences()
{

    ns_start_transaction("GetStockpilePointPreferences");
    ns_web_url ("GetStockpilePointPreferences",
           //"URL=https://blue-mobileapi.gamestop.com/v2/loyalty/fetchPointsPreferences",
           "URL=https://api-test1.gamestop.com/adapter/v2/loyalty/fetchPointsPreferences",
           "METHOD=GET",
...
"HEADER=Pragma:akamai-x-get-client-ip, akamai-x-cache-on, akamai-x-cache-remote-on, akamai-x-check-cacheable, akamai-x-get-cache-key, akamai-x-get-extracted-values, akamai-x-get-nonces, akamai-x-get-ssl-client-session-id, akamai-x-get-true-cache-key, akamai-x-serial-no, akamai-x-feo-trace, akamai-x-get-request-id",
           "HEADER=correlation-id: GetStockpilePointPreferences_{CorrChar}{CorrID}",
     
    );
           ns_end_transaction("GetStockpilePointPreferences", NS_AUTO_STATUS);
