...

{
    ...
    ns_start_transaction("ViewRecommendations");
    ns_web_url ("ViewRecommendations",
           "URL=https://blue-mobileapi.gstop-preprod.com/v2/recommendation/syncdata/viewReco/products-in-all-categories",
          //  "URL=https://blue-mobileapi.gstop-preprod.com/adapter/v2/recommendation/syncdata/viewReco/products-in-all-categories",
           "METHOD=POST",
...
"HEADER=Pragma:akamai-x-get-client-ip, akamai-x-cache-on, akamai-x-cache-remote-on, akamai-x-check-cacheable, akamai-x-get-cache-key, akamai-x-get-extracted-values, akamai-x-get-nonces, akamai-x-get-ssl-client-session-id, akamai-x-get-true-cache-key, akamai-x-serial-no, akamai-x-feo-trace, akamai-x-get-request-id",
           "HEADER=correlation-id: ViewRecommendations_{CorrChar}{CorrID}",
           "BODY=$CAVINCLUDE$=ViewRecommendations.json",
    );
           ns_end_transaction("ViewRecommendations", NS_AUTO_STATUS);
