...
void FetchRewardsByRewardId()
{

    ns_start_transaction("FetchRewardsByRewardId");
    ns_web_url ("FetchRewardsByRewardId",
//           "URL=https://blue-mobileapi.gamestop.com/v2/loyalty/reward?sku={SKUidSP}&categoryType=sweepstakes",
          // "URL=https://blue-mobileapi.gamestop.com/v2/loyalty/reward?sku=2015040101&categoryType=sweepstakes",
            "URL=https://api-test1.gamestop.com/adapter/v2/loyalty/reward?sku=2015040101&categoryType=Sweepstakes",
           "METHOD=GET",
...
"HEADER=Pragma:akamai-x-get-client-ip, akamai-x-cache-on, akamai-x-cache-remote-on, akamai-x-check-cacheable, akamai-x-get-cache-key, akamai-x-get-extracted-values, akamai-x-get-nonces, akamai-x-get-ssl-client-session-id, akamai-x-get-true-cache-key, akamai-x-serial-no, akamai-x-feo-trace, akamai-x-get-request-id",
           "HEADER=correlation-id: FetchRewardsByRewardId_{CorrChar}{CorrID}",
     
    );
           ns_end_transaction("FetchRewardsByRewardId", NS_AUTO_STATUS);
