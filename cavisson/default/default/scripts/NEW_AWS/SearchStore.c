...

{
    ...
    ns_start_transaction("SearchStore");
    ns_web_url ("SearchStore",
          // "URL=https://api-test1.gamestop.com/adapter/v2/storesv2/search?postalCode={PostalCodesFP}",
          "URL=https://api-test1.gamestop.com/adapter/v2/storesv2/search?postalCode={PostalCodesFP}",
          //  "URL=https://blue-mobileapi.gstop-preprod.com/adapter/v2/storesv2/search?postalCode={PostalCodesFP}",
           "METHOD=GET",
...
"HEADER=Pragma:akamai-x-get-client-ip, akamai-x-cache-on, akamai-x-cache-remote-on, akamai-x-check-cacheable, akamai-x-get-cache-key, akamai-x-get-extracted-values, akamai-x-get-nonces, akamai-x-get-ssl-client-session-id, akamai-x-get-true-cache-key, akamai-x-serial-no, akamai-x-feo-trace, akamai-x-get-request-id",
           "HEADER=correlation-id: SearchStore_{CorrChar}{CorrID}",
           
    );
           ns_end_transaction("SearchStore", NS_AUTO_STATUS);
