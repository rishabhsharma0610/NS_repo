/*-----------------------------------------------------------------------------
    Name:Recommendations_ViewProdouct
...
void Recommendations_ViewProdouct()

{
return;

    ns_start_transaction("Recommendations_ViewProdouct");
    ns_web_url ("Recommendations_ViewProdouct",
          "URL=https://blue-mobileapi.gstop-preprod.com/v2/recommendation/syncdata/viewProduct",
          // "URL=https://blue-mobileapi.gstop-preprod.com/adapter/v2/recommendation/syncdata/viewProduct",
           "METHOD=POST",
...
"HEADER=Pragma:akamai-x-get-client-ip, akamai-x-cache-on, akamai-x-cache-remote-on, akamai-x-check-cacheable, akamai-x-get-cache-key, akamai-x-get-extracted-values, akamai-x-get-nonces, akamai-x-get-ssl-client-session-id, akamai-x-get-true-cache-key, akamai-x-serial-no, akamai-x-feo-trace, akamai-x-get-request-id",
           "HEADER=correlation-id: Einsteinsync_viewProduct_{CorrChar}{CorrID}",
           "BODY=$CAVINCLUDE$=Recommendations_viewProduct.json",
    );
           ns_end_transaction("Recommendations_ViewProdouct", NS_AUTO_STATUS);
