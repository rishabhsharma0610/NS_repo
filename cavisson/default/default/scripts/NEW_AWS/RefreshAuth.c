...
char *data = ns_eval_string("{AccessTokenSP}");
ns_save_string(ns_encode_url(data, strlen(data)),"DV_AccessToken_Encoded");

  
    ns_start_transaction("RefreshAuth");
    ns_web_url ("RefreshAuth",
         // "URL=https://mobileapi.gstop-preprod.com/v2/authorization/tokenV2",
         ...
         //  "HEADER=X-Amz-Date: 20200922T085405Z",
          ...
          // "HEADER=x-gs-native-app: android-v4.4.0",
           ...
           "BODY=client_id={Clientid_FP}&client_secret={SecretKeyFP}&grant_type=refresh_token&refresh_token={DV_AccessToken_Encoded}",

    );
           ns_end_transaction("RefreshAuth", NS_AUTO_STATUS);
