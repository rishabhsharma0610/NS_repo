...
void UpdateCart()
{
    ...
    ns_start_transaction("UpdateCart");
    ns_web_url ("UpdateCart",
           "URL=https://blue-mobileapi.gstop-preprod.com/v2/carts/{CartIdSP}/lineitems/{LineItemIdSP}/quantity/2",
          //  "URL=https://blue-mobileapi.gstop-preprod.com/adapter/v2/carts/{CartIdSP}/lineitems/{LineItemIdSP}/quantity/2",
           "METHOD=PUT",
...
"HEADER=Pragma:akamai-x-get-client-ip, akamai-x-cache-on, akamai-x-cache-remote-on, akamai-x-check-cacheable, akamai-x-get-cache-key, akamai-x-get-extracted-values, akamai-x-get-nonces, akamai-x-get-ssl-client-session-id, akamai-x-get-true-cache-key, akamai-x-serial-no, akamai-x-feo-trace, akamai-x-get-request-id",
           "HEADER=correlation-id: UpdateCart_{CorrChar}{CorrID}",
           
     
    );
           ns_end_transaction("UpdateCart", NS_AUTO_STATUS);
