...

{
    ...
    ns_start_transaction("FetchRecommendations");
    ns_web_url ("FetchRecommendations",
          "URL=https://blue-mobileapi.gstop-preprod.com/v2/recommendation/get/products-in-all-categories?maxCount=5",
             //"URL=https://blue-mobileapi.gstop-preprod.com/adapter/v2/recommendation/get/products-in-all-categories?maxCount=5",
           "METHOD=POST",
...
"HEADER=Pragma:akamai-x-get-client-ip, akamai-x-cache-on, akamai-x-cache-remote-on, akamai-x-check-cacheable, akamai-x-get-cache-key, akamai-x-get-extracted-values, akamai-x-get-nonces, akamai-x-get-ssl-client-session-id, akamai-x-get-true-cache-key, akamai-x-serial-no, akamai-x-feo-trace, akamai-x-get-request-id",
           "HEADER=correlation-id: FetchRecommendations_{CorrChar}{CorrID}",
           "BODY=$CAVINCLUDE$=FetchRecommendations.json",
    );
           ns_end_transaction("FetchRecommendations", NS_AUTO_STATUS);
