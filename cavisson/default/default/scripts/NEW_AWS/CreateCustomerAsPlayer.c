...
snprintf(EmailValue, 64, "%s", ns_eval_string("PlayS{DateTimeRP}@bhexacttarget.com"));
ns_save_string(EmailValue,"DV_EmailValue");

ns_save_data_ex("/home/cavisson/Game_Stop/data/GS/Mobile/Adapter_Create_Mobile_PlayerEmailIds.txt",NS_APPEND_FILE,"%s",ns_eval_string("PlayS{DateTimeRP}@bhexacttarget.com,GameStopPerf#01"));
